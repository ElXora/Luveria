...
import net.kdt.pojavlaunch.prefs.GraphicsPresetPreference;
...
public class LauncherPreferenceVideoFragment extends LauncherPreferenceFragment {
    ...
    public void onCreatePreferences(Bundle b, String str) {
        ...
        // Apply default MID preset on first launch if not set
        if (!LauncherPreferences.DEFAULT_PREF.contains("graphics_preset")) {
            GraphicsPresetManager.applyPreset(requireContext(), GraphicsPresetManager.PRESET_MID);
        }
