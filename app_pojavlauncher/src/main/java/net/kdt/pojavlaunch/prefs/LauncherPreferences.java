...
public class LauncherPreferences {
    ...
    // Luveria Graphics Preset: "high" | "mid" | "low"  (default: mid)
    public static String PREF_GRAPHICS_PRESET = "mid";
    ...
    public static void loadPreferences(Context ctx) {
        ...
        PREF_GRAPHICS_PRESET = DEFAULT_PREF.getString("graphics_preset", "mid");
