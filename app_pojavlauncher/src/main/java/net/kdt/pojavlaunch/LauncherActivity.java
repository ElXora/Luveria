...
public class LauncherActivity extends BaseActivity {
    ...
    // private ModloaderInstallTracker mInstallTracker; // modpacks removed
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // IconCacheJanitor.runJanitor(); // modpacks removed

        // Luveria: apply default MID preset if first run
        if (!net.kdt.pojavlaunch.prefs.LauncherPreferences.DEFAULT_PREF.contains("graphics_preset")) {
            GraphicsPresetManager.applyPreset(this, GraphicsPresetManager.PRESET_MID);
        }
        ...
        // mInstallTracker = new ModloaderInstallTracker(this); // modpacks removed
